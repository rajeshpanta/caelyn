...
/// Registered via @UIApplicationDelegateAdaptor in MavieApp.
/// Its single job is to set the UNUserNotificationCenterDelegate at the
/// earliest possible moment so we can:
///   1. Show notifications even when Mavie is foregrounded.
...
final class AppDelegate: NSObject, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    /// Notification Center). We extract the Mavie category from the request
